...
namespace Ramapriya\Telegram\Entity {
     ...
     * @method \Ramapriya\Telegram\Entity\MessageHandler setDefault(\boolean|\Bitrix\Main\DB\SqlExpression $default)
     * @method bool hasDefault()
     * @method bool isDefaultFilled()
     * @method bool isDefaultChanged()
     * @method \boolean remindActualDefault()
     * @method \boolean requireDefault()
     * @method \Ramapriya\Telegram\Entity\MessageHandler resetDefault()
     * @method \Ramapriya\Telegram\Entity\MessageHandler unsetDefault()
     * @method \boolean fillDefault()
